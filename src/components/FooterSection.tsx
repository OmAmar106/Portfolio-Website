      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-muted-foreground mb-10 max-w-md mx-auto">
            Open to internships, collaborations, and competitive programming discussions.
          </p>

          <div className="flex items-center justify-center gap-4 flex-wrap">
            <motion.a
              href="mailto:emailomamar@gmail.com"
              whileHover={{ y: -2 }}
              className="glass glass-hover rounded-xl px-6 py-3 flex items-center gap-3 font-mono text-sm"
            >
              <Mail size={16} className="text-primary" />
              <span>emailomamar@gmail.com</span>
            </motion.a>
            <motion.a
            ...
            <motion.a
              href="https://github.com/OmAmar106"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ y: -2 }}
              className="glass glass-hover rounded-xl px-6 py-3 flex items-center gap-3 font-mono text-sm"
            ...
            <motion.a
              href="https://leetcode.com/OmAmar/"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ y: -2 }}
              className="glass glass-hover rounded-xl px-6 py-3 flex items-center gap-3 font-mono text-sm"
            ...
            <motion.a
              href="https://codeforces.com/profile/OmAmar"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ y: -2 }}
              className="glass glass-hover rounded-xl px-6 py-3 flex items-center gap-3 font-mono text-sm"
